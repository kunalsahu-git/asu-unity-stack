...
const ASUHeader = ({
  ...
  console.log("allowedFullUrls", allowedFullUrls, fullCurrentUrl, isAllowed)
  console.log("fullCurrentUrl", allowedFullUrls, fullCurrentUrl, isAllowed)
  console.log("isAllowed", allowedFullUrls, fullCurrentUrl, isAllowed)
  // const tickerProps = {
