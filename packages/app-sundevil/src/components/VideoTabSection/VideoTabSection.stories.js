...
const props = {
  ...
  video1: {
    ...
    lyric:
      "Fight, Devils Down The Field Fight With Your Might and Don't Ever Yield Long May Our Colors Outshine All Others Echo From The Buttes, Give 'Em Hell Devils! Cheer, Cheer For A-S-U Fight For The Old Maroon For it's Hail, Hail, The Gang's All Here And It's Onward to Victory!",
  },
  video2: {
    ...
    imageSrc:
      "https://dev-web-sda.ws.asu.edu/sites/default/files/2025-05/3c03829479fe4fcd9499b48b5ddcbd60f1d9c33c.webp",
    lyric:
      "Alma Mater Where the bold saguaros '/n' Raise their arms on high Praying strength for brave tomorrows From the western sky Where eternal mountains kneel at sunset's gate Here we hail thee, Alma Mater Arizona State",
  },
};
